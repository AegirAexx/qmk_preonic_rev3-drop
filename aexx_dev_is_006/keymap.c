...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_preonic_1x2uC(
		...
		KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT, KC_TRNS, KC_SPC, MO(3), KC_NO, KC_LCTL, KC_LALT, KC_DEL),
	...
	[2] = LAYOUT_preonic_1x2uC(
		...
		KC_DEL, IS_PLUS, IS_MINS, IS_UNDS, IS_EQL, IS_LCBR, IS_RCBR, IS_DQUO, IS_QUOT, IS_GRV, IS_QUES, KC_NO,
		KC_HOME, IS_PERC, IS_TILD, IS_AMPR, IS_ASTR, IS_LPRN, IS_RPRN, IS_LABK, IS_SCLN, IS_COLN, IS_RABK, KC_END,
		KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT, MO(3), KC_SPC, KC_TRNS, KC_NO, KC_LCTL, KC_LALT, KC_DEL),
	...
	[3] = LAYOUT_preonic_1x2uC(
		RGB_TOG, KC_NO, KC_NO, KC_NO, KC_NO, KC_VOLD, KC_VOLU, KC_NO, KC_NO, KC_NO, DEBUG, RESET,
		KC_NO, KC_NO, KC_HOME, KC_END, KC_NO, KC_NO, KC_NO, KC_X, KC_C, KC_V, KC_NO, KC_NO,
		KC_NO, KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO,
